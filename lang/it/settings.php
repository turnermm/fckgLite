...
$lang['dwedit_ns']             = 'Elenco delle categorie, separate da virgole, dove FckgLite si applica in automatico sull\'editor nativo di DokuWiki.';
...
$lang['nix_style']             = 'Per server Windows (Vista e successivi).  Questa impostazione permette di accedere a data\media attraverso fckgckeditor\userfiles, se i collegamenti a media e file sono stati creati correttamente in userfiles';
$lang['no_symlinks']           = 'Disabilita creazione automatica dei collegamenti simbolici in fckg/userfiles.';
$lang['dw_priority']           = 'Rendi l\'editor di DokuWiki l\'editor di default';
$lang['winstyle']              = 'Usare percorso diretto alla directory media invece di fckeditor/userfiles. Questo richiede che fckeditor/userfiles/.htaccess.security sia copiato in data/media e rinominato .htaccess';
