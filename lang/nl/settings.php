...
$lang['dwedit_ns'] = "Comma gescheiden lijst van namespaces waarbij FckgLite automatisch terugschakelt" .
		"naar de oorspronkelijke DokuWiki Editor.";
...
$lang['nix_style'] = "Voor Windows Servers (Vista en later).  Deze parameter maakt het mogelijk om data\\media te benaderen met fckg\\fckeditor\\userfiles, indien links naar media en bestand succesvol aangemaakt zijn in userfiles";
$lang['no_symlinks']  = "Desactiveer automatische creatie van symbolische links in fckg/userfiles.";
$lang['direction'] = 'Zet de schrijf en lees richting van de taal in FCKeditor:  <b>nocheck</b>: geen wijziging van de verstekwaarde in fckgLite; '
		. ' <b>dokuwiki</b>:  gebruik de Dokuwiki taal schrijfrichting;  <b>ltr</b>: Links-naar-rechts; <b>rtl</b>: Rechts-naar-links.';
