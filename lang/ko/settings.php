...
$lang['xcl_plugins']           = '변할 수 없는 문법 플러그인의 쉼표로 구분된 목록. 플러그인의 이름은 fckg 관리 패널의 플러그인 목록에서 찾을 수 있는 현재 설치된 플러그인의 목록에 나타나는 것과 정확해야 합니다.';
...
$lang['smiley_as_text']        = 'FCKeditor에서 이모티콘을 텍스트로 표시 (여전히 브라우저에서는 그림으로 표시됩니다)';
$lang['editor_bak']            = 'meta/&lt;namespace&gt;.fckg에 백업을 저장';
$lang['create_folder']         = '파일 브라우저에서 폴더 만들기 버튼 활성화 (y/n)';
$lang['dwedit_ns']             = 'FckgLite가 네이티브 도쿠위키 편집기로 자동으로 전환할 이름공간의 쉼표로 구분된 목록.';
...
$lang['nix_style']             = 'Windows 서버 (Vista 이상)를 위해 이 설정은 미디어와 파일로의 링크가 성공적으로 userfiles에 만들어지는 경우, fckgckeditor\userfiles를 통해 data/media에 접근할 수 있도록 합니다';
$lang['no_symlinks']           = 'fckg/userfiles에 심볼릭 링크를 자동으로 만들기를 비활성화합니다.';
$lang['direction']             = 'FCKeditor에서의 언어 방향 설정:  <b>nocheck</b>: fckgLite는 기본 방향 설정을 바꾸지 않습니다;  <b>dokuwiki</b>:  현재 도쿠위키 언어 방향;  <b>ltr</b>: 왼쪽에서 오른쪽; <b>rtl</b>: 오른쪽에서 왼쪽.';
$lang['scayt_auto']            = 'SCAYT 맞춤법 검사기를 자동으로 활성화합니다. 기본값은 "on"입니다; SCAYT를 끄려면 "off"를 선택하세요';
$lang['scayt']                 = 'SCAYT 맞춤법 검사기를 사용합니다. 기본값은 "on"입니다; "off"를 선택하면 spellerpages 검사기로 전환합니다';
